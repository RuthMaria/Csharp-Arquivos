...
Projeto de console onde foi abordado I/O(Input/Output) em C#, para ser capaz de fazer leitura e escrita de arquivos de texto em uma aplicação .net.
...
```
git clone https://github.com/RuthMaria/Csharp-Arquivos.git
```
